...
class TranscriptionHTTPServer:
    ...
    def start(self):
        ...
        log.info("  GET  /health - Basic health check")
        log.info("  GET  /health/detailed - Detailed health information")
        log.info("  GET  /transcriptions - Get all transcriptions")
        log.info("  GET  /transcriptions?limit=N - Get last N transcriptions")
        log.info("  GET  /transcriptions?recent_minutes=N - Get transcriptions from last N minutes")
        log.info("  GET  /transcriptions/search?q=text - Search transcriptions")
        log.info("  GET  /transcriptions/statistics - Get transcription statistics")
        log.info("  GET  /transcriptions/summary?hours=N - Get summary for last N hours")
        log.info("  GET  /transcriptions/{id} - Get specific transcription")
        log.info("  GET  /status - Get pipeline status")
        log.info("  GET  /api-docs - Swagger UI documentation")
        log.info("  GET  /api-docs.json - OpenAPI specification")
        log.info("  POST /transcriptions/export - Export transcriptions to JSON")
        log.info("  POST /transcriptions/send-unsent - Send unsent transcriptions to API")
        log.info("  POST /control/toggle-api-sending - Toggle automatic API sending")
        log.info("  POST /control/start - Start pipeline")
        log.info("  POST /control/stop - Stop pipeline")
